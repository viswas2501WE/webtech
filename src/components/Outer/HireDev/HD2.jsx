    ...
    return (
        <div className="relative" ref={ref}>
            ...
            >
                ...
                <svg className="h-5 w-5 text-gray-400 flex-shrink-0 ml-2" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
const HD2 = () => {
    ...
    return (
        <div className="relative flex items-center justify-center px-4 sm:px-8 md:px-[10%] py-8 sm:py-4" style={{ fontFamily: "Roboto, sans-serif" }}>
            <img src="/Local/gradient-liquid-abstract-background_23-2148911366.jpg" alt="" className="-scale-x-100 absolute object-cover w-full h-full opacity-100 -z-50 flex justify-center items-center" />
            ...
            <div className="p-4 sm:p-8 w-full flex flex-col lg:flex-row max-w-6xl">
                ...
                <div className="lg:w-1/2 md:pr-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                <label htmlFor="name" className="block text-sm font-[500] text-white whitespace-normal break-words">Name<span className="text-red-500">*</span></label>
                                <input type="text" id="name" name="name" value={formData.name} onChange={handleChange} placeholder="Name" className={inputStyle} required />
                            </div>
                            <div>
                                <label htmlFor="email" className="block text-sm font-[500] text-white whitespace-normal break-words">Email<span className="text-red-500">*</span></label>
                                <input type="email" id="email" name="email" value={formData.email} onChange={handleChange} placeholder="Email" className={inputStyle} required />
                            </div>
                        </div>

                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                            <div>
                                <label htmlFor="phone" className="block text-sm font-[500] text-white whitespace-normal break-words">Phone<span className="text-red-500">*</span></label>
                                <input type="tel" id="phone" name="phone" value={formData.phone} onChange={handleChange} placeholder="Phone" className={inputStyle} required />
                            </div>
                        ...
                        <div className="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                <label htmlFor="mentionBudget" className="block text-sm font-[500] text-white whitespace-normal break-words">Mention Budget (In USD)<span className="text-red-500">*</span></label>
                                <input type="number" id="mentionBudget" name="mentionBudget" value={formData.mentionBudget} onChange={handleChange} placeholder="Budget in USD" className={inputStyle} required />
                            </div>
                        </div>
                        ...
                        <div>
                            <label htmlFor="projectRequirements" className="block text-sm font-[500] text-white whitespace-normal break-words">Mention Projects Requirements</label>
                ...
                <div className="lg:w-1/2 hidden lg:flex items-center justify-center mt-8 md:mt-0 px-4 sm:px-0">
                    <Image
                        ...
                        unoptimized // optionally skip optimization if URL fails
                    />
                </div>
            </div>
        </div>
