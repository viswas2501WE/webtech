  ...
  return (
    ...
    >
      ...
      <Image
        ...
        width={48}
        height={48}
        className="absolute top-[30%] left-[5%] w-8 sm:w-10 lg:w-12 xl:w-16 hue-rotate-220"
      />
      <Image
        ...
        width={48}
        height={48}
        className="absolute top-[5%] right-[5%] w-8 sm:w-10 lg:w-13 xl:w-16 hue-rotate-220"
      />
      <Image
        src={`${IMG}/element_56.png`}
        alt="element 56-2"
        width={48}
        height={48}
        className="absolute bottom-[5%] left-[20%] w-8 sm:w-10 lg:w-13 xl:w-16 hue-rotate-220"
      />
      <Image
        ...
        sizes="25vw"
        className="absolute right-[40%] w-1/4 sm:w-[20%] lg:w-[15%] xl:w-[23%] object-contain hue-rotate-220"
      />
      <Image
        ...
        width={48}
        height={48}
        className="absolute bottom-[10%] right-[5%] w-8 sm:w-10 lg:w-13 xl:w-16 hue-rotate-220"
      />
      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8">
          ...
          <Link href="/hire-dev">
            <button
              className="relative font-[500] cursor-pointer overflow-hidden text-white w-full sm:min-w-50 h-13.5
                         px-8 rounded-[2rem] group flex justify-center items-center bg-[#1A96D5]
                         transition-all duration-300"
              style={{ fontFamily: 'Roboto, sans-serif' }}
            >
              <span className="absolute inset-0 bg-[#242D65] scale-y-0 origin-bottom
          ...
          <Link href="/contact-us">
            <button
              className="relative cursor-pointer font-[500] overflow-hidden text-[#1A96D5] w-full sm:min-w-50 h-13.5
              ...
              style={{ fontFamily: 'Roboto, sans-serif' }}
            >
              <span className="absolute inset-0 bg-[#1A96D5] scale-y-0 origin-bottom
                               group-hover:scale-y-100 transition-transform duration-500 ease-in-out" />
              <span className="relative z-10 flex items-center py-2">
