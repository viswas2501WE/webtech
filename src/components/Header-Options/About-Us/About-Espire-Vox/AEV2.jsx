    ...
    >
      ...
      <div className="w-full lg:w-[50%] px-[0.7vw] ">
        ...
        <Link href="/contact-us">
          <button
            style={{ fontFamily: 'Roboto, sans-serif' }}
            className="relative font-[500] cursor-pointer overflow-hidden text-[#FF3147] transition-colors hover:text-white duration-500 ease-in-out w-50 h-13.5 px-8 rounded-[2rem] group flex justify-center items-center bg-white z-0"
          >
            {/* Fill animation */}
