...
const testimonials = [
  ...
  {
    id: 3,
    review: `I was really impressed with the communication. Espire Vox team is very quick to adjust any changes or preferences I had. I was always asked my thoughts and the programmer wanted to make sure I was completely satisfied with every page on my website. Outstanding team! I will definitely hire again!`,
  ...
  {
    id: 5,
    review: `Working closely with Mithil and the Espire Vox team on various projects, their adept communication and PHP expertise stood out. They not only delivered a custom module promptly but also managed to stay below the initial budget, earning my wholehearted recommendation for anyone in need of similar tailored solutions.`,
    name: 'ALISON ROSE',
    title: 'CEO founder',
