...
const featuresData = [
    ...
    },
    {
        ...
        description:
            'By prioritizing open communication and transparency within the team, we, at Espire Vox, create a collaborative and productive environment that fosters trust and contributes to the success of our projects!',
    },
    {
        ...
        description:
            'Espire Vox builds strategies and follows standard practices to optimize costs while maintaining quality and efficiency. We continuously monitor and adapt to changes in order to come up with cost-effective solutions without compromising quality or project success.',
    },
];
    ...
    >
      <div className="flex md:flex-col items-center lg:items-start justify-start mb-3 md:mb-6">
        <div className="w-[10vh] h-[10vh] md:w-[15vh] md:h-[15vh] bg-[#F8F8F8] rounded-full flex items-center justify-center mr-4 md:mr-0 md:-ml-1 flex-shrink-0">
          <div
            className="w-[6vh] h-[6vh] md:w-[8vh] md:h-[8vh] object-contain text-[#F85C70] flex justify-center items-center"
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto max-w-6xl">
        <p className="text-[#F85C70] text-[2.5vh] font-[500] uppercase mb-2">WHY CHOOSE US</p>
        <h2
