'use client'; // Required if used with any client-side logic like `onError`

import React from 'react';
import { FaFacebookF, FaInstagram, FaTwitter } from "react-icons/fa";

const OT1Common = ({ member }) => {
  ...
  return (
    ...
    ">
      {/* Left Decoration */}
      <svg xmlns="http://www.w3.org/2000/svg" width="54.863" height="150.996" viewBox="0 0 54.863 150.996" className="absolute -left-[5%] top-[35%]">
      ...
      {/* Right Decoration */}
      <svg xmlns="http://www.w3.org/2000/svg" width="54.863" height="134.501" viewBox="0 0 54.863 134.501" className="absolute -right-1 top-[5%]">
        <defs>
      ...
      <div className="relative w-32 h-32 md:w-36 md:h-36 rounded-full object-bottom px-2 overflow-hidden mb-4 shadow-md bg-[#F8F8F8]">
        <img
          src={image || 'https://placehold.co/150x150/cccccc/333333?text=Member'}
          alt={name}
          className="w-full h-full object-cover mt-3"
          onError={(e) => {
            e.target.onerror = null;
            e.target.src = 'https://placehold.co/150x150/cccccc/333333?text=Member';
          }}
        />
      </div>
