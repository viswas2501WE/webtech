...
const AdminCommonButton = ({ children, className = '', ...props }) => {
  return (
    <button
      ...
      className={`relative font-[600] text-md overflow-hidden text-white min-w-40 h-13.5 rounded-[2rem] group flex justify-center cursor-pointer items-center bg-[#1A96D5] z-0 ${className}`}
      {...props}
    >
